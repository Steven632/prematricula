<?php
    session_start();
    //numEst, name, year
    $_SESSION['numEst'] = 840211111;
    $_SESSION['name'] = 'José Puig Hernández';
    include("../db_info.php");
    $insert = 'not yet';
...
<div class="wrapper col1">
  <div id="header">
    ...
    <div style="padding-right: 50px" class="fl_right">
...
<div class="wrapper col2">
  <div id="topnav">
    <ul>
      ...
      <li><a href="prematricula.php">Ver Pre-Matrícula</a>
      </li>
                            ...
                            if($row['course_id'] == $previd){
                                ...
                                if($check == true)
                                {
                                    ...
                                    echo'<form id="form'.$formid.'" action="index.php" method="POST">';
                                        ...
                                        echo' <input type="hidden" name="course" value="'.$_POST['course'].'">';
                                        echo'<input type="hidden" name="course_id" value="'.$row['course_id'].'">
                                        <input type="hidden" name="section_id" value="'.$row['course_id'].'-'.$row['section_id'].'">
                                        <li><a href="#">'.$row['section_id'].'
                                ...
                                <div id="featured_wrap">
                                    ...
                                    <form id="form'.$formid.'" action="index.php" method="POST">';
                                            ...
                                            echo '<input type="hidden" name="course_id" value="'.$row['course_id'].'">
                                            <input type="hidden" name="section_id" value="'.$row['section_id'].'">
                                            <li><a href="#">'.$row['course_id'].'-'.$row['section_id'].'
                                            <input type="submit" name="submit3" value=""></a></li>
                                    </form> ';
                                    $formid++;
                                }
